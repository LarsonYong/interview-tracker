export const styles = {
  glassCard:
    "rounded-3xl border border-white/45 bg-white/62 backdrop-blur-xl shadow-[0_8px_28px_rgba(15,23,42,0.06)]",

  glassPanel:
    "rounded-[28px] border border-white/40 bg-white/58 backdrop-blur-xl shadow-[0_10px_30px_rgba(15,23,42,0.06)]",
  ...
  interviewCard:
    "relative overflow-hidden rounded-[28px] border border-white/50 bg-white/68 p-6 text-left backdrop-blur-xl shadow-[0_10px_28px_rgba(15,23,42,0.06)]",

  interviewCompany:
    "text-[1.15rem] font-semibold tracking-tight text-slate-900",
  interviewRole:
    "mt-1.5 text-[15px] leading-6 text-slate-600",
  interviewMeta:
    "mt-5 space-y-2 text-sm text-slate-500",
  ...
  badgeActive:
    "border-sky-200/90 bg-sky-50/90 text-sky-600",

  badgePassed:
    "border-violet-200/90 bg-violet-50/90 text-violet-600",

  badgeRejected:
    "border-slate-200/90 bg-slate-100/90 text-slate-500",

  badgeOffer:
    "border-emerald-200/90 bg-emerald-50/90 text-emerald-600",
  ...
  secondaryButton:
    "inline-flex h-11 items-center justify-center rounded-2xl border border-white/45 bg-white/56 px-5 text-sm font-medium text-slate-700 backdrop-blur-xl transition-all duration-300 hover:-translate-y-0.5 hover:bg-white/68 hover:shadow-[0_8px_20px_rgba(15,23,42,0.08)]",
