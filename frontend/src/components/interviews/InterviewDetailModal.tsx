                        ...
                        <div className="flex flex-col items-center gap-1.5">
                          ...
                          >
                            <button
                              ...
                              className="flex h-5 w-5 items-center justify-center text-[18px] leading-none text-slate-400 transition hover:text-slate-600"
                            >
                              ⋯
                            </button>
                            ...
                            <AnimatePresence>
                              {isMenuOpen ? (
                                <motion.div
                                  ...
                                  className="absolute right-0 top-full z-20 mt-2 w-48 rounded-2xl border border-white/60 bg-white/85 p-2 shadow-[0_16px_40px_rgba(15,23,42,0.12)] backdrop-blur-xl"
                                >
                                  ...
                                  <button
                                    ...
                                    className="w-full rounded-xl px-3 py-2 text-left text-sm text-slate-700 transition hover:bg-white/70 hover:text-slate-900"
                                  >
                                    Mark as inactive
                                  </button>
                                  ...
                                  <button
                                    ...
                                    className="w-full rounded-xl px-3 py-2 text-left text-sm text-rose-500 transition hover:bg-rose-50 hover:text-rose-600"
                                  >
                                    Delete interview
                                  </button>
                                </motion.div>
